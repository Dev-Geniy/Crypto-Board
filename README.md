...
<div style="display: flex; align-items: center;">
    <div style="flex: 1; padding-right: 20px;">
        ![DevGeniy](https://i.ibb.co/4Rj2zQJt/photo-2025-02-17-12-57-12.jpg)
    </div>
    <div style="flex: 2;">
        ## Разработчик: [DevGeniy](https://x.com/HotDog850642)
        ...
        DevGeniy всегда открыт для новых идей и готов рассматривать обновления, которые помогут улучшить функциональность проекта. Вы можете предложить свои изменения и идеи на [GitHub](https://github.com/Dev-Geniy/Crypto-Board/).

        Заходите, участвуйте, и помогите сделать Crypto Board WebApp еще лучше!
